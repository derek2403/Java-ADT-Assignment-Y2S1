...
import RegisterVolunteer from './RegisterVolunteer'; // Assuming the same Register component can be used
import SearchVolunteers from './SearchVolunteer'; // New component for searching volunteers
import SignInVolunteer from './SignInVolunteer'; // Assuming the same SignIn component can be used
...
export default function VolunteerDashboard() {
  ...
  const renderComponent = () => {
    switch (activeComponent) {
      ...
      case 'signin':
        return <SignInVolunteer onSignIn={() => router.push('/volunteer/registered')} />;
      default:
        return null;
    }
  };
  ...
  return (
    <div style={styles.container}>
      <h1 className="typing-effect" style={styles.title}>Hi Volunteer! Choose your action.</h1>
